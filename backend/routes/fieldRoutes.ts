...
router.get('/socials/:userid',asyncHandler(getSocials))
...
router.get('/skills/:userid',asyncHandler(getSkills))
...
router.get('/projects/:userid',asyncHandler(getProjects))
...
router.get('/experience/:userid',asyncHandler(getExperience))
...
router.get('/education/:userid',asyncHandler(getEducation))
...
router.get('/achievements/:userid',asyncHandler(getAchievements))
