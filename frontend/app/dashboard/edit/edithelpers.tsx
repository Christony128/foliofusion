...
export const addAchievement = async (
  ...
  newAchievement: any,
  setAchievements: any,
  setShowAddAchievement: any,
  achievements: any,
  setNewAchievement: any
) => {
  if (!token) return;
  try {
...
export const deleteExperience = async (
  ...
  try {
    const res = await fetch(
      `http://localhost:1100/api/fields/experience/${id}`,
      {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      }
...
export const deleteEducation = async (
  ...
  try {
    const res = await fetch(
      `http://localhost:1100/api/fields/education/${id}`,
      {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      }
...
export const deleteAchievement = async (
  ...
  try {
    const res = await fetch(
      `http://localhost:1100/api/fields/achievements/${id}`,
      {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      }
...
export const getCustomSections = async (
  ...
  if (!token) return;
  try {
    const response = await fetch("http://localhost:1100/api/fields/custom", {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
    ...
    if (response.ok) {
      ...
      console.error("Failed to fetch custom sections");
      setCustomSections([]);
    }
  } catch (err) {
...
export const addCustomSection = async (
  token: string | null,
  newCustom: any,
  setCustomSections: any,
  setShowAddCustom: any,
  customSections: any[],
  setNewCustom: any
) => {
  if (!token) return;
  try {
    const response = await fetch("http://localhost:1100/api/fields/custom", {
      ...
      body: JSON.stringify({
        ...
        content: { text: newCustom.content },
      }),
    });
    ...
    console.error("Error adding custom section:", err);
  }
};
...
export const deleteCustomSection = async (
  ...
  try {
    const response = await fetch(
      `http://localhost:1100/api/fields/custom/${id}`,
      {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    if (response.ok) {
      ...
      console.error("Failed to delete custom section");
    }
  } catch (err) {
